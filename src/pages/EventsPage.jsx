  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-900">{t('navEvents')}</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <CalendarDays size={32} className="text-zinc-300 mb-3" />
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-zinc-100">
                  <th className="text-left px-5 py-3 text-xs font-medium text-zinc-500 uppercase tracking-wide">{t('evtColName')}</th>
                  <th className="text-left px-5 py-3 text-xs font-medium text-zinc-500 uppercase tracking-wide hidden sm:table-cell">{t('evtColDates')}</th>
                  <th className="text-left px-5 py-3 text-xs font-medium text-zinc-500 uppercase tracking-wide hidden md:table-cell">{t('evtColLocation')}</th>
                  <th className="text-left px-5 py-3 text-xs font-medium text-zinc-500 uppercase tracking-wide">{t('evtColItems')}</th>
                  ...
                  >
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <p className="text-sm font-medium text-zinc-900 line-clamp-1">{event.name}</p>
                      </div>
                    </td>
                    <td className="px-5 py-3.5 hidden sm:table-cell">
                      <span className="text-sm text-zinc-500">{formatDateRange(event.start_date, event.end_date)}</span>
                    </td>
                    <td className="px-5 py-3.5 hidden md:table-cell">
                      <span className="text-sm text-zinc-500">{event.location || '—'}</span>
                    </td>
                    <td className="px-5 py-3.5">
                      <span className="text-sm text-zinc-500">{event.item_count ?? 0}</span>
                    </td>
                    <td className="px-5 py-3.5">
